...
- **Endpoint**: `GET/POST https://app-e9as9j53ojk1-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article`
...
async function callWebpageContentExtract(
  ...
  const response = await fetch(
    `https://app-e9as9j53ojk1-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article?${params.toString()}`,
    {
