...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-e9as9j53ojk1-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech` |
| HTTP Method | `POST` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-e9as9j53ojk1-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
    method: "POST",
    headers: {
