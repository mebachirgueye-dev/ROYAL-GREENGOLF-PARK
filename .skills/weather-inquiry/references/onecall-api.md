...
**Endpoint**: `GET https://app-e9as9j53ojk1-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall`
...
**Endpoint**: `GET https://app-e9as9j53ojk1-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine`
...
**Endpoint**: `GET https://app-e9as9j53ojk1-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary`
...
**Endpoint**: `GET https://app-e9as9j53ojk1-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-e9as9j53ojk1-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall?${params}`,
    {
      method: "GET",
      headers: {
...
|----------|-------------------|---------------------|--------------|
| Historical weather for a timestamp | `weather-timemachine.ts` | `lat`, `lon`, `dt` | `https://app-e9as9j53ojk1-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine` |
| Daily aggregated statistics | `weather-day-summary.ts` | `lat`, `lon`, `date` | `https://app-e9as9j53ojk1-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary` |
| AI weather overview | `weather-overview.ts` | `lat`, `lon` | `https://app-e9as9j53ojk1-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview` |
