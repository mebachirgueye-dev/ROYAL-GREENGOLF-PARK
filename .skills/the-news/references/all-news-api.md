...
**Endpoint:** `GET https://app-e9as9j53ojk1-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all`
...
async function getAllNews(params: AllNewsParams = {}): Promise<AllNewsResponse> {
  ...
  const response = await fetch(
    `https://app-e9as9j53ojk1-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
