...
**Endpoint:** `GET https://app-e9as9j53ojk1-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}`
...
async function getSimilarNews(uuid: string, params: SimilarNewsParams = {}): Promise<SimilarNewsResponse> {
  ...
  const response = await fetch(
    `https://app-e9as9j53ojk1-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/${encodeURIComponent(uuid)}${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
